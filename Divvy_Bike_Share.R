...
# The purpose of this script is to consolidate Divvy Biking data
# into a single dataframe and then conduct a comparative analysis to
# help answer the key question: 
# In what ways do members and casual riders use Divvy bikes differently?

#install.packages(c("tidyverse", "lubridate", "ggplot2", "dplyr", "janitor"))
...
setwd("/Users/jcs19/Desktop/Google_Case_Study/Bike_Data")#setting working dir.
...
# (2) The data can only be aggregated at the ride-level, which is too granular (too deep).
...
# Visualization for the total number of rides per month
  ggplot(all_trips_v2, aes(month_name)) +
    geom_histogram(stat = "count",fill = "dodgerblue3") +
...
#=================================================
# Create a csv file to visualize in another software
counts <- aggregate(all_trips_v2$ride_length ~ all_trips_v2$member_casual +
                        all_trips_v2$day_of_week, FUN = mean)
write.csv(counts, file = 'C://Users//jcs19//Desktop//Google_Case_Study//Bike_Data//avg_ride_length.csv')
